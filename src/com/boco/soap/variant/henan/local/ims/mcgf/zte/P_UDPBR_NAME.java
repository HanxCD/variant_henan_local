...
//参数核查中横表多行中兴MGCF的show UDPBR的,取UDPBR中NAME变量的方法
  ...
  extends VariantValueInvoke
{
  ...
  private void initMap(String dbFile)
  {
    ...
    String sql = "SELECT DEVICENAME,GROUP_CONCAT(NAME) CNAME FROM ZTE_MGCF_UDPBR GROUP BY DEVICENAME";
