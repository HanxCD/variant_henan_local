...
//参数核查中横表多行中兴MGCF的show UDPBR的,取V_ZTE_MGCF_UDPBR_05060中NAME名称中含ICSCF/BGCF/SCSCF/LOCAL   这四种的话，参数值定为0或5060
...
public class P_UDPBR_NAME_05060
  extends VariantValueInvoke
{
  ...
  private void initMap(String dbFile)
  {
    ...
    String sql = "SELECT DEVICENAME,GROUP_CONCAT(NAME) CNAME FROM V_ZTE_MGCF_UDPBR_05060 GROUP BY DEVICENAME";
