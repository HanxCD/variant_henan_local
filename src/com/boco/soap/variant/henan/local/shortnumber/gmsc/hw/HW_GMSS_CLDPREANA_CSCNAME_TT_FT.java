 ...
 * 新增
 * ADD CLDPREANA: CSCNAME="ZZTT", CS=ALL, PFX=K'037195186, MINCLDLEN=9,
 ...
 */
public class HW_GMSS_CLDPREANA_CSCNAME_TT_FT extends VariantValueInvoke {
    ...
    public String[] getValues(INeElement arg0, IInstructionParameter arg1, Map<String, ?> data, String dbFile) {
        ...
        if (access_city == null) {
            ...
            if (cityStr.contains(access_city.toString())) {
                return new String[] { this.map.get(access_city) + "TT" };
            }
