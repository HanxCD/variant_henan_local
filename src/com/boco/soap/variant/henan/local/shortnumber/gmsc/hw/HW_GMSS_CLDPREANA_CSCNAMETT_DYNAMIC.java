...
public class HW_GMSS_CLDPREANA_CSCNAMETT_DYNAMIC extends VariantValueInvoke {
    ...
    private void initCityMap(String dbFile, String sNename) {
      ...
      //  String sql = "select  DEVICENAME,COVER_CITY from TCM_HW_GMSS_MTB_REL where GROUP_NAME in (select GROUP_NAME from TCM_HW_GMSS_MTB_REL where DEVICENAME='" + sNename + "')";
