 ...
 *
 */
public class HW_GMSS_CLDPREANA_ACCESSAREA_PFX2 extends VariantValueInvoke {
    ...
    public String[] getValues(INeElement ne, IInstructionParameter arg1, Map<String, ?> data, String arg3) {
        ...
        List<String> cityStr = this.getCoverCity(ne);
        if (cityStr.contains(accessArea.toString())) {
