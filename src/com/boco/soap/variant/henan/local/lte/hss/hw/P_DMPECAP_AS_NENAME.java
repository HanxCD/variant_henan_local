...
//DATE 2018-03-14  wanghao25  华为HSS的DMPECAP查询AS的实体名称,参数核查Cx特性列表
...
public class P_DMPECAP_AS_NENAME extends VariantValueInvoke
{
...
if ((objNeType.toString().trim().toUpperCase().equals("HSS")) && 
  (objActTbName.toString().trim().toUpperCase().equals("DMPECAPAS")) && 
  (paraName != null)) {
...
String sql = "SELECT DEVICENAME,GROUP_CONCAT(NENAME) NENAME FROM HW_HSS_DMPECAP_AS GROUP BY DEVICENAME";
