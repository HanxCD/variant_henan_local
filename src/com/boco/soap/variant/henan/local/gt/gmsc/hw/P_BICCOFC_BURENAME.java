...
public class P_BICCOFC_BURENAME extends VariantValueInvoke
{
...
(objActTbName.toString().trim().toUpperCase().equals("BICCOFC")) && 
(paraName != null)) {
...
String sql = "SELECT DEVICENAME,GROUP_CONCAT(BURENAME) BURENAME FROM V_HW_GMSS_BICCOFC_P GROUP BY DEVICENAME";
