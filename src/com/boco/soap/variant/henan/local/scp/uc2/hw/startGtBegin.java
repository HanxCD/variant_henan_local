...
public class startGtBegin extends VariantValueInvoke {
    ...
    private void initMap(String dbFile, String deviceName) {
        ...
        String sql = "SELECT PROVINCE,START_GT FROM  TCM_CMCC_BOSS_GT m WHERE START_GT not IN (SELECT MSISDNSTART FROM  HW_SCP_UC2 q WHERE DEVICENAME='" + deviceName + "') ORDER BY START_GT ";
