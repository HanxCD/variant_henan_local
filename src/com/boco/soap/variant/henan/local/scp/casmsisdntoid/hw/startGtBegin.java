...
public class startGtBegin extends VariantValueInvoke {
    private static final Logger LOGGER = LoggerFactory.getLogger(startGtBegin.class);
    ...
    public String[] getValues(INeElement arg0, IInstructionParameter arg1, Map<String, ?> data, String arg3) {
        ...
        if (null == o) {
            ...
            LOGGER.info("省份：{}，resultList.size:{}", data.get("PROVINCE").toString(), resultList.size());
    ...
    private void initMap(String dbFile, String deviceName) {
        ...
        String sql = "SELECT PROVINCE,START_GT FROM  TCM_CMCC_BOSS_GT m WHERE START_GT not IN (SELECT MSISDNSTART FROM  HW_SCP_CAS_MSISDNTOID q WHERE DEVICENAME='" + deviceName + "') ORDER BY START_GT ";
