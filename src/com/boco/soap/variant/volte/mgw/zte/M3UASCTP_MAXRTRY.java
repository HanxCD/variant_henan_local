...
//参数核查中兴IMSMGW的查询指令的M3UASCTP出来的"通路数据重传的最大次数"

public class M3UASCTP_MAXRTRY extends VariantValueInvoke
{
	  ...
	  private void initStr(String dbFile)
	  {
	    ...
	    String sql = "SELECT t.PARAM_VALUE FROM TCM_ALL_CS_VOLTEPARAM  t WHERE  t.ne_type='IMSMGW' AND t.VENDOR_NAME='中兴' AND t.ACT_TBNAME='M3UASCTP' AND t.param_name='MAXRTRY'";
